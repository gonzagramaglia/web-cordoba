...
($jscomp.defineProperty =
    ...
    ($jscomp.polyfill = function (t, e, r, n) {
        if (e) {
            ...
            (e = e((n = r[(t = t[t.length - 1])]))) != n && null != e && $jscomp.defineProperty(r, t, { configurable: !0, writable: !0, value: e });
        }
    }),
    $jscomp.polyfill(
...
!(function (t, e) {
    ...
    function p(t, r) {
        switch (l(t, r)) {
            case "transform":
                return (function (t, r) {
                    var n,
                        o = -1 < (n = r).indexOf("translate") || "perspective" === n ? "px" : -1 < n.indexOf("rotate") || -1 < n.indexOf("skew") ? "deg" : void 0;
    ...
    function v(t, e) {
        ...
        if (((r = P.pth(t) ? t.totalLength : t), P.col(r)))
            if (P.rgb(r)) {
                ...
                r = P.hex(r)
                    ...
                    ? (function (t) {
                          function e(t, e, r) {
                              return 0 > r && (r += 1), 1 < r && --r, r < 1 / 6 ? t + 6 * (e - t) * r : 0.5 > r ? e : r < 2 / 3 ? t + (e - t) * (2 / 3 - r) * 6 : t;
                          }
        ...
        return { original: (r += ""), numbers: r.match(n) ? r.match(n).map(Number) : [0], strings: P.str(t) || e ? r.split(n) : [] };
    }
    function b(t) {
    ...
    function j(t, e) {
        ...
        if (P.arr(t)) {
            var o = t.length;
            2 !== o || P.obj(t[0]) ? P.fnc(e.duration) || (r.duration = e.duration / o) : (t = { value: t });
        }
        return n(t)
            .map(function (t, r) {
                return (r = r ? 0 : e.delay), (t = P.obj(t) && !P.pth(t) ? t : { value: t }), P.und(t.delay) && (t.delay = r), t;
            })
            .map(function (t) {
                return u(t, r);
            });
    ...
    function w(t) {
        var n,
            ...
            d = [],
            m = u(c, f);
        for (n in t) m.hasOwnProperty(n) || "targets" === n || d.push({ name: n, offset: m.offset, tweens: j(t[n], f) });
        return (
            (s = d),
            u(c, {
                children: [],
                    ...
                    r(
                        p.map(function (t) {
                            return s.map(function (e) {
                                ...
                                if (r) {
                                    var n = $(e, t);
                                    e = { type: r, property: e.name, animatable: t, tweens: n, duration: n[n.length - 1].end, delay: n[0].delay };
                                } else e = void 0;
                                return e;
                            });
                        })
    ...
    function A(t) {
        ...
        function o(t) {
            for (var r = 0, n = {}, o = m.animations, a = o.length; r < a; ) {
                ...
                for (
                    var c = Math.min(Math.max(t - s.start - s.delay, 0), s.duration) / s.duration, l = isNaN(c) ? 1 : s.easing(c, s.elasticity), p = ((c = s.to.strings), s.round), d = [], g = void 0, y = ((g = s.to.numbers.length), 0);
                    y < g;
                    y++
                ) {
                    var v = void 0,
                ...
                if ((s = c.length)) for (g = c[0], l = 0; l < s; l++) (p = c[l + 1]), (y = d[l]), isNaN(y) || (g = p ? g + (y + p) : g + (y + " "));
                else g = d[0];
                L[i.type](u.target, i.property, g, n, u.id), (i.currentValue = g), r++;
            }
            if ((r = Object.keys(n).length)) for (o = 0; o < r; o++) I || (I = f(document.body, "transform") ? "transform" : "-webkit-transform"), (m.animatables[o].target.style[I] = n[o].join(" "));
        ...
        function u(t) {
            ...
            (h >= f || !e) && (m.began || ((m.began = !0), a("begin")), a("run")),
                h > u && h < e ? o(h) : (h <= u && 0 !== g && (o(0), y && i()), ((h >= e && g !== e) || !e) && (o(e), y || i())),
                a("update"),
                t >= e && (m.remaining ? ((c = s), "alternate" === m.direction && (m.reversed = !m.reversed)) : (m.pause(), m.completed || ((m.completed = !0), a("complete"), "Promise" in window && (p(), (d = r())))), (l = 0));
        }
        t = void 0 === t ? {} : t;
        var s,
            c,
        ...
        return (
            (m.reset = function () {
                var t = m.direction,
                    e = m.loop;
                for (m.currentTime = 0, m.progress = 0, m.paused = !0, m.began = !1, m.completed = !1, m.reversed = "reverse" === t, m.remaining = "alternate" === t && 1 === e ? 2 : e, o(0), t = m.children.length; t--; )
                    m.children[t].reset();
            }),
            (m.tick = function (t) {
    ...
    var I,
        M = { update: void 0, begin: void 0, run: void 0, complete: void 0, loop: 1, direction: "normal", autoplay: !0, offset: 0 },
        ...
        k = (function () {
            ...
            return function (e, r, n, o) {
                if (0 <= e && 1 >= e && 0 <= n && 1 >= n) {
                    ...
                    if (e !== r || n !== o) for (var i = 0; 11 > i; ++i) a[i] = t(0.1 * i, e, n);
                    return function (i) {
                        if (e === r && n === o) return i;
                        if (0 === i) return 0;
                        if (1 === i) return 1;
    ...
    return (
        ...
        (A.remove = function (t) {
            t = b(t);
            for (var e = C.length; e--; ) for (var r = C[e], n = r.animations, a = n.length; a--; ) o(t, n[a].animatable.target) && (n.splice(a, 1), n.length || r.pause());
        }),
        (A.getValue = p),
        (A.path = function (e, r) {
                    ...
                    (o = this),
                        (a = function (t) {
                            if (!o.isReady) {
                                ...
                                return o.el
                                    ? (r.getAttribute("built-by-vivus") && (o.parentEl.insertBefore(o.el, r), o.parentEl.removeChild(r), o.el.setAttribute("width", "100%"), o.el.setAttribute("height", "100%")),
                                      (o.isReady = !0),
                                      o.init(),
                                      !0)
                                    : void 0;
                ...
                (n = r[e]),
                    this.isInvisible(n) ||
                        ...
                        isNaN(a.length)
                            ...
                            : (this.map.push(a),
                              (n.style.strokeDasharray = a.length + " " + (a.length + 2 * this.dashGap)),
                ...
                switch (((a = this.map[e]), this.type)) {
                    ...
                    case "scenario-sync":
                        (n = r[e]),
                            ...
                            (u = void 0 !== i["data-async"] ? a.startAt : a.startAt + a.duration),
                    ...
                    h
                        ? ((i.src = f),
                          ...
                          "iframe" === h &&
                              ...
                              (i.contentProvider = d),
                              (i.opts.slideClass += " fancybox-slide--" + ("gmap_place" == d || "gmap_search" == d ? "map" : "video"))))
                        : (i.type = "image"));
            });
        });
    })(window.jQuery),
